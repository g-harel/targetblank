resource "aws_api_gateway_rest_api" "targetblank" {
  name        = "targetblank-api"
  description = "targetblank api"
}
...
resource "aws_api_gateway_deployment" "targetblank" {
  ...
  rest_api_id = "${aws_api_gateway_rest_api.targetblank.id}"
  stage_name  = "${var.env}"
}

resource "aws_api_gateway_resource" "api" {
  rest_api_id = "${aws_api_gateway_rest_api.targetblank.id}"
  parent_id   = "${aws_api_gateway_rest_api.targetblank.root_resource_id}"
  path_part   = "api"
}
